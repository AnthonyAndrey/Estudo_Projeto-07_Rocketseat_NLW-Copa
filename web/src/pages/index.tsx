  ...
  return (
    <div className='max-w-[1124px] mx-auto grid grid-cols-2 items-center h-screen gap-28'>
      <main>
        ...
        <form onSubmit={event=>createPool(event)} className='mt-10 flex gap-2'>
          <input
      ...
      <Image
        src={appPreviewImg}
        alt="dois celulares exibiundo uma prévia da aplicação NLE Copa"
        quality={100}
      />
    </div>
  )
...
export const getServerSideProps = async () => {
  // para executar as promisses em paralelo utilize o Promisse.all
